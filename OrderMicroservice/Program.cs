...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.Console()
    .WriteTo.File("logs/order-microservice-.txt", rollingInterval: RollingInterval.Day)
    .CreateLogger();
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        Log.Information("Database connection verified for Order Microservice");
    }
    catch (Exception ex)
    {
...
Log.Information("Order Microservice starting on port 5005");
