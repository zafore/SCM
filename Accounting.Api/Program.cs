...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.Console()
    .WriteTo.File("logs/accounting-microservice-.txt", rollingInterval: RollingInterval.Day)
    .CreateLogger();
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        Log.Information("Database connection verified for Accounting Microservice");
    }
    catch (Exception ex)
    {
...
Log.Information("Accounting Microservice starting on port 5009");
